...
#define index_pageX	"<!DOCTYPE html>"\
"<html>"\
	"<head>"\
				...
				"<table type ='table' class='tab'>"\
					"<tbody>"\
						"<tr>"\
							...
							"<td style='color: #000000; width:10%; align: left'><input type='text' class='sts_label' value='Ver 1.0' disabled='disabled'/></td>"\
...
#define netinfoOLD "<!DOCTYPE html>"\
							"<html>"\
								"<head>"\
...
#define netinfo_page_slave_OLD 		"<!DOCTYPE html>"\
							"<html>"\
								"<head>"\
								...
								"<body onload='getNetinfo();'>"\
									"<div>"\
									"Slave clock web Server Network info"\
									"</div>"\
									"<br>"\
									"<ul>"\
										"<li><label for='txtmac'>MAC:</label><input id='txtmac' name='mac' type='text' size='20' disabled='disabled'/></li> "\
										...
										"<li><label for='txtsn'>SN:</label><input id='txtsn' name='sn' type='text' size='20' disabled='disabled'/></li> "\
										"<li><label for='txtdns'>DNS:</label><input id='txtdns' name='dns' type='text' size='20' disabled='disabled'/></li> "\
										"<li><label for='txtntpip'>NTP time server:</label><input id='txtntpip' name='ntp' type='text' size='20' disabled='disabled'/></li> "\
									"</ul>"\
								"</body>"\
							"</html>"
...
"<html>"\
	...
	"<body>"\
		"<div id='main'>"\
			"<div id='head'>NTP CLOCK LIMITED</div>"\
			"<div id='net_info_general'>"\
				"<div id ='list_head'>"\
					"<h1>Network information</h1>"\
				"</div>"\
...
"        </div>"\
"        <div id=\"clock_info\">"\
"            <div id=\"list_head\"><h1>Time(+7 Hanoi)</h1></div>"\
"            <table class=\"tab\">"\
"                <tbody>"\
"                    <tr>"\
"                        <td>"\
...
"                        <td style=\"color: #000000; width:10%; text-align:left\"><input type=\"text\" class=\"sts_label\" value=\"Ver 1.0\" disabled /></td>"\
...
#define fullconfigpage			"<!DOCTYPE html>"\
							"<html>"\
								...
								"<FORM METHOD='POST' action='config.cgi'><br>"\
									...
									"<br>"\
									"<ul>"\
										"<li><label for='ip'>IP:</label><input id='txtip' name='ip' type='text' size='20' value=\"192.168.22.212\"></li> "\
										"<li><label for='gw'>GW:</label><input id='txtgw' name='gw' type='text' size='20' value=\"192.168.22.252\"></li> "\
										"<li><label for='sn'>SN:</label><input id='txtsn' name='sn' type='text' size='20' value=\"255.255.255.0\"></li> "\
										"<li><label for='txtdns'>DNS:</label><input id='txtdns' name='dns' type='text' size='20' value=\"8.8.4.4\"></li> "\
										...
										"<li><label for='txtlight'>LED light:</label><input id='txtlight' name='light' type='text' size='20' value=\"15\"> max 15, min 3</li><br> "\
