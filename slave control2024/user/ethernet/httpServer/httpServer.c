...
void loadwebpages(void)
{
		...
		//config page
		reg_httpServer_webContent((uint8_t *)"config.html", (uint8_t *)confightml);			// config.html
		reg_httpServer_webContent((uint8_t *)"fullconfig.html", (uint8_t *)fullconfightml);			// fullconfig.html
