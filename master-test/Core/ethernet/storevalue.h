...
#define FLASH_USER_END_ADDR     (ADDR_FLASH_PAGE_47 + FLASH_PAGE_SIZE - 1)   /* End @ of user Flash area */

#define DATA_32                 ((uint32_t)0x12345678)
#define DATA_64                 ((uint64_t)0xC0A816A312345678)
#define DATA2_64                 ((uint64_t)0x1111111111111111)
