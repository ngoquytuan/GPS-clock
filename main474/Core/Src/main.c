...
uint8_t days,months,years,hours,minutes,seconds ;
/* USER CODE END 0 */
...
int main(void)
{
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
		/*
		- Cho tin hieu GPS => neu co PPS thi thoi gian chuan
		- Cho tin hieu RTC PULSE?
		- Chon GPS nao tin hieu TOT hon neu ca 2 GPS deu A
		- Gui tin hieu dong bo di
		*/
		tasks();
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, MAIN_PPS_Pin|LCD_D4_Pin|LCD_D5_Pin|LCD_D6_Pin
  ...
  /*Configure GPIO pins : MAIN_PPS_Pin LCD_D4_Pin LCD_D5_Pin LCD_D6_Pin
                           LCD_D7_Pin LED_GPS2_Pin LED_GPS1_Pin LED_CPU_Pin */
  GPIO_InitStruct.Pin = MAIN_PPS_Pin|LCD_D4_Pin|LCD_D5_Pin|LCD_D6_Pin
                          |LCD_D7_Pin|LED_GPS2_Pin|LED_GPS1_Pin|LED_CPU_Pin;
